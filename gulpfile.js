...
function devFonts() {
  return src(`${options.paths.src.fonts}/**/*.{ttf,woff,eot,svg}`).pipe(
...
exports.default = series(
  ...
  parallel(devFonts, devStyles, devScripts, devImages, devHTML), //Run All tasks in parallel
...
exports.prod = series(
  ...
  parallel(prodFonts, prodStyles, prodScripts, prodImages, prodHTML), //Run All tasks in parallel
  buildFinish
);
